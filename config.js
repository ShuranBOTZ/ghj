...
/*============== STAFF ==============*/
global.owner = [
  ['6281271010619', 'Shur', true], 
  ['6281271010619', 'vnja', true]
...
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘「𝑺𝒉𝒖𝒓𝒂𝒏𝑩𝑶𝑻𝒁 」˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ 「𝑺𝒉𝒖𝒓𝒂𝒏𝑩𝑶𝑻𝒁 」 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Shur`
global.packname = '𒈞sнuʀᴀɴʙoтz𒈞'
global.author = '                「 SHURAN-BOT  あ」'
